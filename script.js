...
function handleNo() {
  ...
  if (noClickCount === 1) {
    question.innerText = "Soch le acha se!🙄";
    subtext.innerText = "itte jldi mtt bol 😏";
    image.src = "https://media.giphy.com/media/l0MYt5jPR6QX5pnqM/giphy.gif"; // Thinking/side-eye
  } else if (noClickCount === 2) {
    question.innerText = "Ek aur baar Soch le!😣";
    subtext.innerText = "";
    image.src = "https://media.giphy.com/media/xT0xeJpnrWC4XWblEk/giphy.gif"; // Worried face
  } else {
    question.innerText = "Manja na! kitna bhav khegi😭";
    subtext.innerText = "bht glt baat hai😭";
